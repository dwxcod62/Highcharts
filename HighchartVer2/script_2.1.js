...
const shipList = [
    { value: "Puteri Mayang", label: "Puteri Mayang" },
    { value: "Puteri Santubong", label: "Puteri Santubong" },
    { value: "Newbuild Vessel 10", label: "Newbuild Vessel 10" },
    { value: "Puteri Ledang", label: "Puteri Ledang" },
    { value: "Newbuild Vessel 1", label: "Newbuild Vessel 1" },
    { value: "Newbuild Vessel 9", label: "Newbuild Vessel 9" },
    { value: "Newbuild Vessel 3", label: "Newbuild Vessel 3" },
    { value: "Newbuild Vessel 5", label: "Newbuild Vessel 5" },
    { value: "Newbuild Vessel 4", label: "Newbuild Vessel 4" },
    { value: "Newbuild Vessel 11", label: "Newbuild Vessel 11" },
    { value: "Puteri Sejinjang", label: "Puteri Sejinjang" },
    { value: "Newbuild Vessel 2", label: "Newbuild Vessel 2" },
    { value: "Puteri Mahsuri", label: "Puteri Mahsuri" },
    { value: "Seri Ayu", label: "Seri Ayu" },
    { value: "Seri Cenderawasih", label: "Seri Cenderawasih" },
    { value: "Newbuild Vessel 8", label: "Newbuild Vessel 8" },
    { value: "Seri Camellia", label: "Seri Camellia" },
    { value: "Seri Cemara", label: "Seri Cemara" },
    { value: "third_0.062", label: "third_0.062" },
    { value: "third_0.008", label: "third_0.008" },
    { value: "Seri Camar", label: "Seri Camar" },
    { value: "third_0.033", label: "third_0.033" },
    { value: "third_0.067", label: "third_0.067" },
    { value: "third_0.068", label: "third_0.068" },
    { value: "third_0.065", label: "third_0.065" },
    { value: "Seri Cempaka", label: "Seri Cempaka" },
    { value: "third_0.07", label: "third_0.07" },
    { value: "Seri Angkasa", label: "Seri Angkasa" },
    { value: "Seri Begawan", label: "Seri Begawan" },
    { value: "Newbuild Vessel 6", label: "Newbuild Vessel 6" },
    { value: "Newbuild Vessel 7", label: "Newbuild Vessel 7" },
    { value: "Puteri Saadong", label: "Puteri Saadong" },
    { value: "Seri Bijaksana", label: "Seri Bijaksana" },
    { value: "Seri Amanah", label: "Seri Amanah" },
    { value: "Puteri Zamrud", label: "Puteri Zamrud" },
    { value: "Seri Alam", label: "Seri Alam" },
    { value: "Puteri Nilam", label: "Puteri Nilam" },
    { value: "Seri Anggun", label: "Seri Anggun" },
    { value: "Puteri Mutiara Satu", label: "Puteri Mutiara Satu" },
    { value: "Lagenda Suria", label: "Lagenda Suria" },
    { value: "Lagenda Serenity", label: "Lagenda Serenity" },
    { value: "Lagenda Setia", label: "Lagenda Setia" },
    { value: "Tangguh Batur", label: "Tangguh Batur" },
    { value: "Puteri Intan", label: "Puteri Intan" },
    { value: "Puteri Delima", label: "Puteri Delima" },
    { value: "Puteri Firus Satu", label: "Puteri Firus Satu" },
    { value: "Aman Sendai", label: "Aman Sendai" },
    { value: "Methane Heather Sally", label: "Methane Heather Sally" },
    { value: "Ibri LNG", label: "Ibri LNG" },
    { value: "KMarin Diamond", label: "KMarin Diamond" },
];

const all_ship = shipList.map((ship) => ship.value);
...
function processData(jsonData) {
    ...
    jsonData.forEach((data) => {
        ...
        if (year === 2024 && !ship.includes("fob") && availableCharacter.includes(character)) {
...
function deleteShipNotAvailable(shipData) {
    let temp = shipData;
    for (let key in temp) {
        if (!all_ship.includes(key)) {
            delete temp[key];
        }
    }
    return shipData;
...
const loadData = async () => {
    try {
        ...
        let { shipData, uniqueStatuses } = processData(jsonData);

        calculateUtilization(shipData);
        addMissingStatuses(shipData, uniqueStatuses);

        shipData = deleteShipNotAvailable(shipData);

        console.log(all_ship.length);
        ...
        const seriesArray = prepareSeriesArray(totalUtilizationByShip, shipData, uniqueStatuses);
