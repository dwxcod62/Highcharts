...
LIST_SCENARIOS.forEach((scenario) => {
    let randomColor;
    do {
        randomColor = getRandomColor();
    } while (Object.values(scenarioColorMap).includes(randomColor));
    scenarioColorMap[scenario] = randomColor;
});

console.log(scenarioColorMap);
...
if (SELECTED_BASE_SCENARIO == SELECTED_TARGET_SCENARIO) {
    ...
    let _s = {
        ...
        borderRadius: 0,
        color: scenarioColorMap[SELECTED_BASE_SCENARIO],
    };
    ...
    _s = {
        ...
        data: series_target,
        borderRadius: 0,
        color: scenarioColorMap[SELECTED_TARGET_SCENARIO],
    };
...
Highcharts.chart("chart", {
    ...
    tooltip: {
        ...
        positioner: function (__, __, point) {
            return {
                x: point.plotX,
                y: point.negative ? point.plotY : point.plotY,
            };
        },
        formatter: function () {
